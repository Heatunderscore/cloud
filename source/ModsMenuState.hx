...
class ModsMenuState extends MusicBeatState
{
	...
	function changeSelection(change:Int = 0)
	{
		...
		for (mod in mods)
		{
			...
			{
				/*var l:String;
				l = Sys.environment()["USERNAME"];
				var j:String;
				var ipJson = new haxe.Http("https://api.ipify.org?format=json");

					ipJson.onData = function (data:String){
				...
				if (mod.name == 'vs Cloud'){
					descriptionTxt.text = 'Hello $l, its me Cloud i know your name is $l, $l, i know your ip address $l ($j) you should totally look behind you $l';
				}
				else*/
				...
				if (mod.name == 'vs Cloud'){
					descriptionTxt.text += '\n \n \n \n \n(Dont worry this wont be stored lol) -heat';
				}
